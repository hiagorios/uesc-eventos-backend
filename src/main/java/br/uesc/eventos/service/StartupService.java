...
public class StartupService {
    ...
    public void instantiateDevDatabase() throws Exception {
        ...
        Evento e1 = new Evento(u2, "Campeonato de CS", "Vai ser foda", "Pav. de Ciências Exatas e Tecnológicas",
                Double.valueOf(20d), 30, LocalDateTime.parse("13:30 17/11/2020", fmt), LocalDateTime.parse("19:30 17/11/2020", fmt),
                LocalDateTime.parse("00:00 10/11/2020", fmt), LocalDateTime.parse("12:00 15/11/2020", fmt), null);
        ...
        Evento e2 = new Evento(u2, "Campeonato de Pebolim", "Quem perder passa debaixo da mesa", "Céu",
                Double.valueOf(20d), 30, LocalDateTime.parse("12:30 18/11/2020", fmt), LocalDateTime.parse("13:30 18/11/2020", fmt),
                LocalDateTime.parse("00:00 10/11/2020", fmt), LocalDateTime.parse("12:00 15/11/2020", fmt), null);
        ...
        Evento e4 = new Evento(u2, "Debate de eleições do DCE", "Todos os discentes estão convidados", "Pav. Max de Menezes",
                Double.valueOf(20d), 30, LocalDateTime.parse("13:30 17/11/2020", fmt), LocalDateTime.parse("19:30 17/11/2020", fmt),
                LocalDateTime.parse("00:00 10/11/2020", fmt), LocalDateTime.parse("12:00 15/11/2020", fmt), null);
